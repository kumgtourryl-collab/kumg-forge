-- ============================================================
-- KUMG Forge — Full Database Setup (v6, final)
-- Includes: admin, DOB age verification, AI chat, payments,
...
-- ============================================================
-- 13. AUTO-BACKFILL existing auth users
-- ============================================================
insert into public.profiles (id, username, email)
select
  u.id,
...
-- ============================================================
-- 14. MAKE kumgtourryl@gmail.com THE ADMIN
-- ============================================================
